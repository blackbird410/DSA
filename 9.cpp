...
public:
  ...
  ~BinaryTreeInArray() { delete[] array; }
...
public:
  ...
  void displayInorder() { traverse(root, INORDER); }
  void displayPreorder() { traverse(root, PREORDER); }
  void displayPostorder() { traverse(root, POSTORDER); }
};
